...
public class LightsaberTrail : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Material trailMaterial = Instantiate(_meshParent.GetComponent<SpriteRenderer>().sharedMaterial);
        trailMaterial.SetColor("Color_8F0C0815", _colour);
        _meshParent.GetComponent<SpriteRenderer>().sharedMaterial = trailMaterial;

        Material bladeMaterial = Instantiate(_blade.GetComponent<SpriteRenderer>().sharedMaterial);
        bladeMaterial.SetColor("Color_AF2E1BB", _colour);
        _blade.GetComponent<SpriteRenderer>().sharedMaterial = bladeMaterial;
